...
// https://github.com/ejirocodes/vue3-otp-input/blob/main/src/App.vue
//import ASingleOtpInput from './a-single-otp-input.vue';
 ...
 *
 * @example
 * 1. If the user is entering the OTP in the order of the input index,
 * then the input will be focused in the order of the input index
 * 2. If the user is entering the OTP in the reverse order of the input index,
 * then the input will be focused in the reverse order of the input index
 */
