  ...
  <Transition name="slide-up">
    <div v-show="isOpen" class="article-contents__container">
      ...
      <div class="p-article__section">
        ...
        <ReviewAuthor :name="author?.name" :description="author?.description" :image="author?.image?.url" />
      </div>
    </div>
  </Transition>
</template>
...
import ReviewCategories from './Categories.vue';
import ReviewAuthor from './Author.vue';
